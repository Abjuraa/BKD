...
if (isset($_POST['registro'])) {
    if (strlen($_POST['nombres']) >= 1 && strlen($_POST['tip_doc']) >= 1 && strlen($_POST['num_doc']) >= 1 && strlen($_POST['correo']) >= 1 && strlen($_POST['contrasena']) >= 1 && strlen($_POST['rol']) >= 1){
        ...
        $consulta = "INSERT INTO `login`(`nom`, `email`, `pass`, `id_tip_doc`, `n_doc`, `id_rol`) VALUES ('$name','$email','$pass','$tip_doc','$num_doc','$rol')";
