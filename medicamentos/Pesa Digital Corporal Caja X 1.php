                    ...
                    <div class="wrapper">
                        <div class="breadcrumb">
                            <ul class="flexitem">
                                ...
                                <li>Pesa Digital Corporal Caja X 1</li>
                            </ul>
                        </div>
                        <!-- breadcrumb -->
                        ...
                        <div class="column">
                            <div class="products one">
                                <div class="flexwrap">
                                        ...
                                        <div class="item is_sticky">
                                            ...
                                            <div class="big-image">
                                                <div class="big-image-wrapper swiper-wrapper">
                                                    <div class="image-show swiper-slide">
                                                        <a data-fslightbox href="../img/products/pesa digital.jpg"><img src="../img/products/pesa digital.jpg" alt=""></a>
                                                    </div>
                                                    
                                                    <div  class="image-show swiper-slide">
                                                        <a data-fslightbox href="../img/products/pesa digital reverza.jpg"><img src="../img/products/pesa digital reverza.jpg" alt=""></a>
                                                    </div>
                                                </div>
                                            ...
                                            <div thumbSlider="" class="small-image">
                                                <ul class="small-image-wrapper flexitem swiper-wrapper">
                                                    ...
                                                    <li class="thumbnail-show swiper-slide">
                                                        <img src="../img/products/pesa digital reverza.jpg" alt="">
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="item">
                                            <h1>Pesa Digital Corporal Caja X 1</h1>
                                            <div class="content">
                                                <div class="rating">
                                                    <div class="stars"></div>
