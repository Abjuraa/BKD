                    ...
                    <div class="wrapper">
                        <div class="breadcrumb">
                            <ul class="flexitem">
                                ...
                                <li>Vitamina C + B2 + Zinc Easylife Tubo X 20 Tabletas Efervescente Sabor </li>
                            </ul>
                        </div>
                        <!-- breadcrumb -->
                        ...
                        <div class="column">
                            <div class="products one">
                                <div class="flexwrap">
                                        ...
                                        <div class="item is_sticky">
                                            ...
                                            <div class="big-image">
                                                <div class="big-image-wrapper swiper-wrapper">
                                                    <div class="image-show swiper-slide">
                                                        <a data-fslightbox href="../img/products/163031_1-VITAMINA_C.jpg"><img src="../img/products/163031_1-VITAMINA_C.jpg" alt=""></a>
                                                    </div>
                                                    
                                                    <div  class="image-show swiper-slide">
                                                        <a data-fslightbox href="../img/products/163031_2-VITAMINA_C_reversa.jpg"><img src="../img/products/163031_2-VITAMINA_C_reversa.jpg" alt=""></a>
                                                    </div>
                                                </div>
                                            ...
                                            <div thumbSlider="" class="small-image">
                                                <ul class="small-image-wrapper flexitem swiper-wrapper">
                                                    ...
                                                    <li class="thumbnail-show swiper-slide">
                                                        <img src="../img/products/163031_2-VITAMINA_C_reversa.jpg" alt="">
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="item">
                                            <h1>Vitamina C + B2 + Zinc Easylife Tubo X 20 Tabletas Efervescente Sabor </h1>
                                            <div class="content">
                                                <div class="rating">
                                                    <div class="stars"></div>
