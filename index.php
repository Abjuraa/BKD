...
<body>
    <div id="page" class="site page-home">
        ...
        include("php/getProductStar.php");
        include("php/getProductListOffert.php");
        include("php/getRandomProductList.php");
                ...
                <div class="container">
                    <div class="wrapper">
                        <div class="column">
                            ...
                            <div id ="rowRandom" class="products main flexwrap">
...
<script src="js/productsRandomLogic.js"></script>
</body>
</html>