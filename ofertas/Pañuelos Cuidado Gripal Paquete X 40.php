...
<head>
    ...
    <title>Pañuelos Cuidado Gripal Paquete X 40r</title>
                    ...
                    <div class="wrapper">
                        <div class="breadcrumb">
                            <ul class="flexitem">
                                ...
                                <li>Pañuelos Cuidado Gripal Paquete X 40</li>
                            </ul>
                        </div>
                        <!-- breadcrumb -->
                        ...
                        <div class="column">
                            <div class="products one">
                                <div class="flexwrap">
                                            ...
                                            <div class="big-image">
                                                <div class="big-image-wrapper swiper-wrapper">
                                                    <div class="image-show swiper-slide">
                                                        <a data-fslightbox href="../img/products/panuelos.jpg"><img src="../img/products/panuelos.jpg" alt=""></a>
                                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="item">
                                            <h1>Pañuelos Cuidado Gripal Paquete X 40</h1>
                                            <div class="content">
                                                <div class="rating">
                                                    <div class="stars"></div>
